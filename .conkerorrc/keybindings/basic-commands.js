...
function bind_scroll_keys (keymap) {
    define_key(keymap, "space", "eye-guide-scroll-down");
    define_key(keymap, "S-space", "eye-guide-scroll-up");
    ...
    define_key(keymap, "k","cmd_scrollLineUp");
    define_key(keymap, "j","cmd_scrollLineDown");
    define_key(keymap, "H","cmd_scrollLeft");
    define_key(keymap, "L","cmd_scrollRight");
